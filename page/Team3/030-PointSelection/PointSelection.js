...
const pageIdentifier = 'PointSelection'; // index 页面标识符，确保与其他页面不同
const columns = 3; // 5列
const rows = 1; // 1行
...
// 按钮对应的跳转链接
const links = [
    '../031-20Quiz/SelectQuestion.html',  // 第一个按钮的跳转地址
    '../032-40Quiz/SelectQuestion.html',  // 第二个按钮的跳转地址
    '../033-60Quiz/SelectQuestion.html',  // 第三个按钮的跳转地址
];
...
document.querySelector('.next-round-button').addEventListener('click', function() {
    window.location.href = '../040-TieBreaker/SelectQuestion.html'; // 确保链接正确
});